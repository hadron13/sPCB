...
if [ ! -f build/libs/cimgui_impl_opengl3.o ]; then
    clang++ cimgui/imgui/backends/imgui_impl_opengl3.cpp -c -o build/libs/cimgui_impl_opengl3.o -Icimgui/imgui
fi

if [ ! -f build/libs/cimgui_impl_sdl3.o ]; then
    clang++ cimgui/imgui/backends/imgui_impl_sdl3.cpp -c -o build/libs/cimgui_impl_sdl3.o -Icimgui/imgui
fi
